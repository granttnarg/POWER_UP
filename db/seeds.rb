...
power_one = Superpower.new(name: "Invisibility", description: "No one can see me duh!", availability: true, price: 60 )
user_one.save!
...
power_two = Superpower.new(name: "Immortality", description: "No one can kill me!", availability: true, price: 110)
user_two.save!
...
power_three = Superpower.new(name: "Flying", description: "In the sky and shit", availability: true, price: 40)
user_three.save!
