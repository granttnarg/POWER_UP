...
power_one = Superpower.new(name: "Invisibility", description: "No one can see me duh!", availability: true)
user_one.save!
...
power_two = Superpower.new(name: "Immortality", description: "No one can kill me!", availability: true)
user_two.save!
...
power_three = Superpower.new(name: "Flying", description: "In the sky and shit", availability: true)
user_three.save!
...
power_four = Superpower.new(name: "To silence people", description: "To shut up all of the chatterboxes", availability: true)
user_four.save!
