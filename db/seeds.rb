...
power_one = Superpower.new(name: "Invisibility", description: "No one can see me duh!", availability: true, price: 60, address: "Rudi-Dutschke-Straße 26, 10969 Berlin"  )
user_one.save!
...
power_two = Superpower.new(name: "Immortality", description: "No one can kill me!", availability: true, price: 110, address: 'Friedrichstraße 207, 10969 Berlin')
user_two.save!
...
power_three = Superpower.new(name: "Flying", description: "In the sky and shit", availability: true, price: 40, address: "Am Wriezener Bahnhof, 10243 Berlin")
user_three.save!
...
power_four = Superpower.new(name: "To silence people", description: "To shut up all of the chatterboxes", availability: true, price: 25, address: "20 W 34th St, New York, NY 10001, USA")
user_four.save!
